function [pf_estimate,pf_real,cov_estimate,real_relative_error]=reliabiliy_evaluation_single_fidelity(search_x,mu,kriging_model,test_function)
% this function is used to evaluate the performance of the current
% iteration
[num_vari,mu_vari,sigma_vari,~,~]=test_function_single_fidelity(test_function);
